        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
          <div class="px-6 py-4 border-b border-gray-200">
            ...
            <p class="mt-1 text-sm text-gray-500">
              Update your payment account information where payments will be received.
            </p>
          </div>
...
export default {
  ...
  data() {
    return {
      form: this.$inertia.form({
        payment_method: this.bankAccount.payment_method || 'bank_transfer',
        ...
        account_type: this.bankAccount.account_type || 'checking',
        currency: this.bankAccount.currency || 'USD',
        country_code: this.bankAccount.country_code || 'US',
  ...
  methods: {
    ...
    submitForm() {
      this.form.put(route('bank-accounts.update', this.bankAccount.id), {
        onSuccess: () => {
